...
union GBAOAM {
	...
	uint16_t raw[512] __attribute__((aligned(4))); // EMSCRIPTEN alignment.. see int32* cast;
};
...
struct GBAVideo {
	...
	uint16_t palette[512] __attribute__((aligned(4)));	// EMSCRIPTEN alignment.. see int32* cast
	uint16_t* vram;
	union GBAOAM oam;
